...
sudo chown root:root ${OUTDIR}/rootfs/bin/busybox # Set the BusyBox binary as setuid root
...
cp -a ${SYSROOT}/lib64/{ld-*,libc.so.*,libc-*,libm.so.*,libm-*,libresolv.so.*,libresolv-*} ${OUTDIR}/rootfs/lib64
